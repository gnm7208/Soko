...
import { Banknote, CheckCircle2, ChevronLeft, Loader2, MapPin, Store, Truck } from "lucide-react";
...
import { CardBrandsLogo, MpesaLogo } from "./PaymentLogos";
...
const paymentOptions: Array<{ id: PaymentMethod; label: string; description: string; icon: ComponentType<{ className?: string }>; iconClassName: string }> = [
  { id: "M-Pesa", label: "M-Pesa", description: "Pay via mobile money", icon: MpesaLogo, iconClassName: "h-6 w-9" },
  { id: "Card", label: "Card", description: "Visa · Mastercard", icon: CardBrandsLogo, iconClassName: "h-6 w-12" },
  { id: "Cash on delivery", label: "Cash on delivery", description: "Pay the rider", icon: Banknote, iconClassName: "h-5 w-5" },
];
