...
export function ShopSettingsDialog({ open, shop, onOpenChange, onUpdated }: ShopSettingsDialogProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="rounded-2xl border-border bg-card p-5 sm:max-w-md">
        <DialogHeader className="text-left"><p className="font-heading text-[11px] font-semibold uppercase tracking-[.14em] text-primary">Shop settings</p><DialogTitle className="font-heading text-xl font-bold">Edit your shop</DialogTitle><DialogDescription className="font-body text-xs text-muted-foreground">Update how buyers see {shop.name}.</DialogDescription></DialogHeader>
